...
var Layers = {
	...
	tiled : new OpenLayers.Layer.WMS(
		"Tiled",
		"http://geovision.uned.ac.cr:80/geoserver/gestiona/wms",
		{
	...
	uned : new OpenLayers.Layer.WMS(
		"Centros de la UNED", 
		"http://geovision.uned.ac.cr/geoserver/cppi/wms", 
		{
			LAYERS : 'cppi:CeUs',
			STYLES : '',
			format : "image/png",
...
Layers.uned.BBOX = new OpenLayers.Bounds(-85.95, 8.036, -82.559, 11.221);
Layers.tiled.BBOX = new OpenLayers.Bounds(-85.95, 8.036, -82.559, 11.221);
...
Layers.uned.META = "http://geovision.uned.ac.cr/geonetwork/srv/spa/search#|899c30f5-5061-44df-aea6-04067c5c3dd1";
Layers.tiled.META = "http://geovision.uned.ac.cr/geonetwork/srv/spa/search#|899c30f5-5061-44df-aea6-04067c5c3dd1";


var layers = [Layers.gmap, Layers.arboles, Layers.zona, Layers.tiled, Layers.uned];
